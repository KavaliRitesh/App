...
export class AboutUsComponent {
  ...
  mission = "Carzy is committed to revolutionizing the car rental experience, providing hassle-free, reliable, and budget-friendly rental services for travelers and commuters.";
