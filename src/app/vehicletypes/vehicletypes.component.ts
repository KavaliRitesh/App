...
export class VehicletypesComponent {
  ...
  public booknow() {
    this.sharedService.setCityAndCar(this.selectlocation, this.selectedcars.name);
    console.log('City and Car set in shared service:', this.selectlocation, this.selectedcars.name);
